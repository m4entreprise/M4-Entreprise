...
const surMesurePage = companyData.services_details.creation_web.sites_metiers;

const processSteps = [
  {
    number: '01',
    title: 'Audit',
    description: 'Analyse de vos processus actuels et de vos objectifs',
  },
  {
    number: '02',
    title: 'Conception',
    description: 'Ateliers fonctionnels et maquettes détaillées',
  },
  {
    number: '03',
    title: 'Développement',
    description: 'Construction de l’application métier sur-mesure',
  },
  {
    number: '04',
    title: 'Déploiement',
    description: 'Mise en production, formation et accompagnement',
  },
];
...
<template>
  <Head title="Sur-mesure - M4 Entreprise" />
      ...
      <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="max-w-5xl mx-auto text-center">
          ...
          <div class="inline-flex items-center gap-2 px-4 py-2 glass-strong rounded-full border border-primary/30 mb-8">
            <PhCode :size="16" class="text-primary" weight="duotone" />
            <span class="text-sm font-medium text-white">Applications métier</span>
          </div>

          <h1 class="text-4xl sm:text-5xl md:text-6xl lg:text-7xl xl:text-8xl font-display font-bold mb-8 leading-[1.05]">
            <span class="gradient-text drop-shadow-[0_0_40px_rgba(108,76,255,0.6)]">Sur-mesure</span>
          </h1>

          <p class="text-xl md:text-2xl lg:text-3xl text-foreground/80 mb-12 max-w-3xl mx-auto font-medium leading-relaxed">
            {{ surMesurePage.description }}
          </p>
        ...
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-6">
              Pourquoi une <span class="gradient-text">application sur-mesure</span> ?
            </h2>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div
              v-for="(objectif, index) in surMesurePage.objectifs"
              :key="index"
    ...
    <section :ref="(el) => setSectionRef(el, 1)" class="py-20 relative overflow-hidden">
      ...
      <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-6">
              Exemples d'<span class="gradient-text">applications métiers</span>
            </h2>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              v-for="(exemple, index) in surMesurePage.exemples"
              :key="index"
              class="p-6 glass-strong rounded-2xl border border-white/10 hover:border-primary/40 transition-all duration-300"
            >
              <div class="flex items-start gap-4">
                <div class="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center flex-shrink-0">
                  <PhGear :size="24" class="text-primary" weight="duotone" />
                </div>
                <p class="text-foreground/90 text-lg">{{ exemple }}</p>
              </div>
            </div>
          </div>
        </div>
    ...
    <section :ref="(el) => setSectionRef(el, 2)" class="py-20 relative">
      <div class="container mx-auto px-6 lg:px-12">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-6">
              Tout ce que votre <span class="gradient-text">outil métier</span> peut faire
            </h2>
          </div>

          <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div
              v-for="(fonctionnalite, index) in surMesurePage.fonctionnalites"
              :key="index"
            ...
            >
              <div class="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center flex-shrink-0">
                <PhRocket :size="24" class="text-primary" weight="duotone" />
              </div>
      ...
      <div class="container mx-auto px-6 lg:px-12 relative z-10">
        <div class="max-w-5xl mx-auto">
          <div class="glass-strong rounded-3xl p-12 border border-white/10">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div
                v-for="techno in surMesurePage.technos"
                :key="techno"
                class="p-6 glass rounded-2xl border border-white/10 hover:border-primary/30 transition-all duration-300"
              >
                <div class="flex items-center gap-4">
                  <div class="w-12 h-12 rounded-xl bg-primary/20 flex items-center justify-center flex-shrink-0">
                    <PhShieldCheck :size="24" class="text-primary" weight="duotone" />
                  </div>
    ...
    <section :ref="(el) => setSectionRef(el, 4)" class="py-20 relative">
      <div class="container mx-auto px-6 lg:px-12">
        <div class="max-w-7xl mx-auto">
          <div class="text-center mb-16">
            <h2 class="text-3xl sm:text-4xl md:text-5xl font-display font-bold text-white mb-6">
              Notre <span class="gradient-text">méthode</span>
            </h2>
          </div>
          ...
          <div class="glass-strong rounded-3xl p-12 md:p-16 border border-primary/30 hover:border-primary/50 transition-all duration-500 hover:shadow-2xl hover:shadow-primary/20">
            <div class="text-center">
              <div class="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-gradient-to-br from-primary to-accent mb-8 shadow-xl shadow-primary/30 animate-float">
                <PhCode :size="40" class="text-white" weight="duotone" />
              </div>

              <h2 class="text-3xl sm:text-4xl md:text-5xl font-display font-bold mb-6 text-white leading-tight">
                Prêt à créer votre <br />
                <span class="gradient-text drop-shadow-[0_0_30px_rgba(108,76,255,0.5)]">outil sur-mesure</span> ?
              </h2>

              <p class="text-xl text-muted-foreground mb-12 max-w-2xl mx-auto leading-relaxed">
                Discutons de vos besoins métier et concevons ensemble l’outil qui simplifiera votre quotidien.
              </p>
